  ...
  return <main className="login-page">
    ...
    <section className="login-panel"><div className="login-card">
      ...
      <form onSubmit={submit} noValidate>
        <label className="login-label" htmlFor="email">Email</label><div className="login-field"><span>@</span><input id="email" type="email" value={email} onChange={(e) => { setEmail(e.target.value); setSelected(null); setError(''); }} placeholder="name@bajajauto.co.in" autoComplete="username"/></div>
